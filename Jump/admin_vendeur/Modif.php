    ...
    <div class="container my-5">
        ...
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <input type="name" class="form-control" name="image" value="<?= $image ?>">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="descri"><?= $descri ?></textarea>
            </div>
            <button type="submit" name="Valider" class="btn btn-success float-right">Enregistrer</button>
        </form>
...
<?php 
    ...
    if(isset($_POST['Valider']))
    {
        if(isset($_POST['image']) AND isset($_POST['nom']) AND isset($_POST['prix']) AND isset($_POST['descri']))
        {
            ...
            modifier($image, $nom, $prix, $descri, $id);
